...
#Generator uses this to pick subsequent words until it reaches the selected length
#Sentence length is semi-randomly pre-selected based on the distribution in the sense set
starts = []
comboDict = {}
...
while len(foo) < len(lines):
    senLen = round(np.random.normal(loc=18.321038698355096,scale=3.9869650085541544))
